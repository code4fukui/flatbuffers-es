...
class ByteBuffer {
    ...
    __has_identifier(ident) {
        ...
        for(let i = 0; i < 4; i++){
            if (ident.charCodeAt(i) != this.readInt8(this.position() + 4 + i)) {
                return false;
            }
        }
        return true;
...
class Builder {
    ...
    endObject() {
        ...
        outer_loop: for(i = 0; i < this.vtables.length; i++){
            ...
            if (len == this.bb.readInt16(vt2)) {
                for(let j = 2; j < len; j += SIZEOF_SHORT){
    ...
    finish(root_table, opt_file_identifier, opt_size_prefix) {
        ...
        if (opt_file_identifier) {
            ...
            this.prep(this.minalign, 4 + 4 + size_prefix);
...
export { SIZEOF_SHORT as SIZEOF_SHORT };
export { SIZEOF_INT as SIZEOF_INT };
export { FILE_IDENTIFIER_LENGTH as FILE_IDENTIFIER_LENGTH };
export { SIZE_PREFIX_LENGTH as SIZE_PREFIX_LENGTH };
export { int32 as int32, float32 as float32, float64 as float64, isLittleEndian as isLittleEndian };
export { Encoding as Encoding };
export { Builder as Builder };
export { ByteBuffer as ByteBuffer };
